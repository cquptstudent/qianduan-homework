...
//         }
//     }
//     allBackground.style.background = `linear-gradient(rgba(${numbers[0]}, ${numbers[1]}, ${numbers[2]}, ${numbers[4]}), rgba(${Math.floor(numbers[0] * 0.4)}, ${Math.floor(numbers[1] * 0.4)}, ${Math.floor(numbers[2] * 0.4)}, ${numbers[4]}))`
// }
